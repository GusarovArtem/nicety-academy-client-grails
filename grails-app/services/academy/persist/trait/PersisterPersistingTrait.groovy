...
import static academy.persist.change.ChangeType.*
import static academy.utils.Closures.delegate
...
trait PersisterPersistingTrait {
    ...
    private updateOwners(entity, Class type, ChangeType changeType, ChangeSource changeSource) {
